...
export function isValid(manifold: ManifoldObject): boolean {
  return manifold.status() === 0; // 0 = NoError in manifold-3d
}

/**
 * Get status code for a manifold
 */
export function getStatus(manifold: ManifoldObject): number {
 ...
 */
export function project(manifold: ManifoldObject): CrossSectionObject {
