...
console.log(`🏗️  Simple backend running on http://localhost:42069`);
console.log(`Health: http://localhost:42069/health`);
console.log(`API:   http://localhost:42069/api/evaluate`);
