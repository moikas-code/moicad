...
export class Shape {
   ...
   *
   * @param file - Path to heightmap file (PNG, DAT, or text file with values)
   ...
   * @param options.convexity - Convexity parameter for rendering (default: 1)
   *
   * @example
   * Shape.surface('terrain.png')
   * Shape.surface('heightmap.dat', { center: true, invert: false })
   */
  static surface(
    file: string,
    options?: {
